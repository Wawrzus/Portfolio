<?php
    ...
    namespace Pgimkius\View\Html\Praca;
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/praca.css">
    <title>Imkius</title>
</head>
<body>
    ...
    <div class="mobile_version">
        ...
        <div class="mobile_main">
            ...
            <div class="mobile_headline_praca">
    
                <ul>
    
                    <li id="mobile_naglowek"><h2>Obecnie poszukujemy pracowników na stanowiska:</h2></li>
    
                </ul>
    
            </div>

            <div class="mobile_text_praca">
...
<div class="mobile_mapa">
    ...
    <div class="main">
        ...
        <div class="main_second">
            ...
            <div class="headline_praca">
    
                <ul>
    
                    <li id="naglowek"><h2>Obecnie poszukujemy pracowników na stanowiska:</h2></li>
