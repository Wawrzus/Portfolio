...
<body>
    ...
    <?php
        ...
        if($publishers)
        {
            ?><form action="usun_zapytanie_iframe" id="formularz" method="post"><?php
            foreach($publishers as $publishers)
            {
                ?>
                    ...
                    <div class="box">
                        ...
                        <div class="box-r"><input type="submit" name="<?php echo $publishers['zapID'] ?>" value="Usuń" id="guzik"></input></div>
