<?php
    ...
    namespace Pgimkius\View\Html\Aktualnosci;
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/aktualnosci.css">
    <title>Imkius</title>
</head>
<body>
    ...
    <div class="mobile_version">
        ...
        <div class="mobile_main">
            ...
            <div class="mobile_main_second">

                <?php
                    $odczyt -> odczyt_mobile_aktualnosci();
                ?>
